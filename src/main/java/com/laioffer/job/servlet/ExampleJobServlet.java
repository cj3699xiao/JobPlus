...
public class ExampleJobServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ExampleCoordinates postCoordinates = new ExampleCoordinates(39.485130, -122.148316);
        ExampleJob postJob = new ExampleJob("Software Cleaner", 1008611, "Aug 1, 2021", false, postCoordinates);
        String mapped =  mapper.writeValueAsString(postJob);
...
//        response.getWriter().print("This is the example job servlet");
        String readFromClient = request.getParameter("readFromClient");

        System.out.println("What I got is: " + readFromClient);
