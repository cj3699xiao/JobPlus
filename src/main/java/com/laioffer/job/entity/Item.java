...
@JsonIgnoreProperties(ignoreUnknown = true) // still find matches, if there is several unmatched jason data!
@JsonInclude(JsonInclude.Include.NON_NULL)  // if null, then don't add it ！
public class Item { // every item is a job
    private String id;
    ...
    public Item() { // must have this, jackson will use this one to create it
    ...
    @JsonProperty("id")  //  what will map on returned jason,
    public String getId() {
        return id;
    }
    ...
    @JsonProperty("company_logo") //SnakeCase, has to match the jason attributes
